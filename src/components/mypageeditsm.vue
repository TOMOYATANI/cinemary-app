            ...
            <div class="profile-items flex">
              ...
              <div class="profile-contens flex">
                <select
                  class="profile-select"
                  v-model="profession"
                  :style="{ color: profession == '' ? 'gray' : 'black' }"
                >
...
.mypageedit-sm {
  ...
  .modal-inner {
    ...
    .update-btn {
      ...
      color: #fff;
      background: #e62f2f;
      box-shadow: 0 0 5px #e62f2f, 0 0 40px #e62f2f, 0 0 80px -6px;
      outline: none;
      border: none;
      border-radius: 0.5rem;
      font-weight: bold;
